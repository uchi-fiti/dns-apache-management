...
Adding files to /etc/bind/ and cd-ing to it
editing named.conf.local and adding the zone
Creating the file db.example.com
And adding the DNS records
Editing resolv.conf and change nameserver 127.0.0.1
Checking if nothing is wrong 
Restarting bind9 ok
Digging it